...
@NgModule({
  declarations: [AppComponent, SampleRowComponent, IntroComponent, CustomHeadersComponent, StripedRowsComponent, CondensedTableComponent, HoverableTableComponent, BorderedTableComponent, AlwaysResponsiveTableComponent, CustomRowComponentComponent, DisableSortingComponent, PreSortedComponent, DisableSortOnColumnComponent, DisableSortWithPreSortColumnComponent, SortableTableComponent, PreSortedUsingTableColumnComponent],
